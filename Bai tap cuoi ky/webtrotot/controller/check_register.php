...
$newname="library/image/".$image_name;
echo "mv".$newname;
...
<?php
  ...
  $email=$_POST['email'];
  $phone=$_POST['phone'];
  $path="library/image/user.jpg";
   $created_at=date('Y-m-d H:i:s');
  $sql="insert into users(`name`, `username`, `address`, `phone`, `image`, `email`, `password`,created_at) VALUES ('$name','$username','$address','$phone','$path','$email','$password','$created_at')";
