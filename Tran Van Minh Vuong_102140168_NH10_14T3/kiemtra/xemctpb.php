<?php
  ...
  $sql="select * from phongban inner join nhanvien on phongban.idpb=nhanvien.idpb where nhanvien.idpb='".$id."'";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <h1 class="text-success"><center> Thông tin chi tiết phòng ban </center></h1>
    <div class="row">
      <div class="col-md-2">
      </div>
    ...
    <div class="row">
      ...
      <tr><td>Tên phòng ban</td><td>Id Nhân viên</td><td>Họ tên</td><td>Địa chỉ</td><td>Thao tác</td></tr>
